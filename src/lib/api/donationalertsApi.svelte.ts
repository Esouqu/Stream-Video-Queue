...
class DonationAlertsApi {
	private _user: DonationAlertsUserData | null = $state(null);

	public clearUser() {
		this._user = null;
	}

	public setUser(user: DonationAlertsUserData) {
		this._user = user;
	}
	...
	public async getUser(): Promise<DonationAlertsUserData | null> {
